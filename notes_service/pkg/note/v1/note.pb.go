...
func (x *SetIconRequest) Reset() {
	*x = SetIconRequest{}
	mi := &file_proto_note_v1_note_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetIconRequest) Descriptor() ([]byte, []int) {
	return file_proto_note_v1_note_proto_rawDescGZIP(), []int{12}
}
...
func (x *SetHeaderRequest) Reset() {
	*x = SetHeaderRequest{}
	mi := &file_proto_note_v1_note_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetHeaderRequest) Descriptor() ([]byte, []int) {
	return file_proto_note_v1_note_proto_rawDescGZIP(), []int{13}
}
...
const file_notes_service_proto_note_v1_note_proto_rawDesc = "" +
	"\n" +
	"\x18proto/note/v1/note.proto\x12\x04note\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xd2\x04\n" +
	"\x04Note\x12\x0e\n" +
...
var file_proto_note_v1_note_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
func file_proto_note_v1_note_proto_init() {
	...
	file_proto_note_v1_note_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}

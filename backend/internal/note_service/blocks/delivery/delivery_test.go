...
func TestBlocksDelivery_CreateBlock_NoUserID(t *testing.T) {
	...
	body := baseCreateBlockRequest{Type: models2.BlockTypeText}
	bodyBytes, _ := json.Marshal(body)
...
func TestBlocksDelivery_UpdateBlockPosition(t *testing.T) {
	...
	mockUsecase.EXPECT().UpdateBlockPosition(gomock.Any(), uint64(1), uint64(1), nil).Return(&models2.Block{
		ID:        1,
		NoteID:    1,
		Type:      models2.BlockTypeText,
		Position:  2.0,

...
func (f *fakeNotesRepo2) GetNotes(ctx context.Context, userID uint64) ([]models.Note, error) {
	return f.notes, nil
}
func (f *fakeNotesRepo2) CreateNote(ctx context.Context, userID uint64) (*models.Note, error) {
	return &models.Note{ID: 1, OwnerID: userID}, nil
}
func (f *fakeNotesRepo2) GetNoteById(ctx context.Context, noteID uint64, userID uint64) (*models.Note, error) {
	return &models.Note{ID: noteID, OwnerID: userID}, nil
}
func (f *fakeNotesRepo2) UpdateNote(ctx context.Context, noteID uint64, title *string, isArchived *bool) (*models.Note, error) {
	return &models.Note{ID: noteID, OwnerID: 1, Title: "ok"}, nil
}

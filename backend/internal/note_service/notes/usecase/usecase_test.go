...
func (r *nu_fakeRepo) GetNotes(ctx context.Context, userID uint64) ([]models.Note, error) {
	return []models.Note{{ID: 1, OwnerID: r.owner}}, nil
}
func (r *nu_fakeRepo) CreateNote(ctx context.Context, userID uint64) (*models.Note, error) {
	return &models.Note{ID: 2, OwnerID: r.owner}, nil
}
func (r *nu_fakeRepo) GetNoteById(ctx context.Context, noteID uint64, userID uint64) (*models.Note, error) {
	return &models.Note{ID: noteID, OwnerID: r.owner}, nil
}
func (r *nu_fakeRepo) UpdateNote(ctx context.Context, noteID uint64, title *string, isArchived *bool) (*models.Note, error) {
	return &models.Note{ID: noteID, OwnerID: r.owner, Title: *title}, nil
}
...
func (r *errRepo) GetNotes(ctx context.Context, userID uint64) ([]models.Note, error) {
	return nil, fmt.Errorf("db")
}
func (r *errRepo) CreateNote(ctx context.Context, userID uint64) (*models.Note, error) {
	return nil, fmt.Errorf("db")
}
func (r *errRepo) GetNoteById(ctx context.Context, noteID uint64, userID uint64) (*models.Note, error) {
	return nil, fmt.Errorf("db")
}
func (r *errRepo) UpdateNote(ctx context.Context, noteID uint64, title *string, isArchived *bool) (*models.Note, error) {
	return nil, fmt.Errorf("db")
}
func (r *errRepo) DeleteNote(ctx context.Context, noteID uint64) error { return fmt.Errorf("db") }
func (r *errRepo) AddFavorite(ctx context.Context, userID, noteID uint64) error {
	return fmt.Errorf("db")
}
func (r *errRepo) RemoveFavorite(ctx context.Context, userID, noteID uint64) error {
	return fmt.Errorf("db")
}
